                    ...
                    do
                        ...
                        then
                            ...
                            do
                                ...
                                REMOTE_GPU_USER="sishan"
                                REMOTE_GPU_HOST="TODO"
                                COMMAND_LEADER="just async_std example_gpuvid_leader multi-validator-push-cdn -- ${fixed_leader_for_gpuvid} ${orchestrator_url} &"
                                ssh $REMOTE_GPU_USER@$REMOTE_GPU_HOST "$COMMAND_LEADER exit"
                                ...
                                COMMAND_LEADER_SHUTDOWN="for pid in $(ps -ef | grep "validator" | awk '{print $2}'); do kill -9 $pid; done"
                                ssh $REMOTE_GPU_USER@$REMOTE_GPU_HOST "$COMMAND_LEADER_SHUTDOWN exit"
