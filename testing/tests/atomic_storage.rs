...
//
//     let round_one_pre_check : Box<dyn FnOnce(&mut TestRunner<TestNetwork, AtomicStorage, DEntryBlock, DemoState>) -> LocalBoxFuture<Vec<Transaction>>>
//         = Box::new(|runner: &TestRunner<
//         TestNetwork,
//         AtomicStorage,
//         DEntryBlock,
//         DemoState,
...
//          async move { runner.add_random_transactions(1).unwrap() }.boxed_local()
//     };
//
...
//             setup_round: Some(Box::new(round_one_setup)),
//             safety_check_pre: Some(Box::new(round_one_pre_check)),
//             safety_check_post: Some(Box::new(round_one_post_check)),
//         }]),
...
//         },
//         rounds: Some(vec![Round {
//             setup_round: Some(Box::new(round_two_setup)),
//             safety_check_pre: Some(Box::new(round_two_pre_check)),
//             safety_check_post: Some(Box::new(round_two_post_check)),
//         }]),
