...
test-ci-1 *ARGS:
  echo Testing {{ARGS}}
  RUST_LOG=error,hotshot=debug,libp2p-networking=debug cargo test tests_1 --verbose --lib --bins --tests --benches --workspace --no-fail-fast --features "dependency-tasks" {{ARGS}} -- --test-threads=1
