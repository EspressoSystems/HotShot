...
test-ci *ARGS:
  echo Testing {{ARGS}}
  cargo test --verbose --lib --bins --tests --benches --workspace --no-fail-fast {{ARGS}} -- --test-threads=1 --nocapture

test-ci-rest *ARGS:
  echo Testing {{ARGS}}
  cargo test --verbose --lib --bins --tests --benches --workspace --no-fail-fast {{ARGS}} -- --skip tests_1 --skip tests_2 --skip tests_3 --skip tests_4 --skip tests_5 --test-threads=1 --nocapture

test-ci-1 *ARGS:
  echo Testing {{ARGS}}
  cargo test tests_1 --verbose --lib --bins --tests --benches --workspace --no-fail-fast {{ARGS}} -- --test-threads=1 --nocapture

test-ci-2 *ARGS:
  echo Testing {{ARGS}}
  cargo test tests_2 --verbose --lib --bins --tests --benches --workspace --no-fail-fast {{ARGS}} -- --test-threads=1 --nocapture

test-ci-3 *ARGS:
  echo Testing {{ARGS}}
  cargo test tests_3 --verbose --lib --bins --tests --benches --workspace --no-fail-fast {{ARGS}} -- --test-threads=1 --nocapture

test-ci-4 *ARGS:
  echo Testing {{ARGS}}
  cargo test tests_4 --verbose --lib --bins --tests --benches --workspace --no-fail-fast {{ARGS}} -- --test-threads=1 --nocapture

test-ci-5 *ARGS:
  echo Testing {{ARGS}}
  cargo test tests_5 --verbose --lib --bins --tests --benches --workspace --no-fail-fast {{ARGS}} -- --test-threads=1 --nocapture
