    ...
    let expectations = vec![
        ...
        Expectations::from_outputs_and_task_states(
            all_predicates![
                ...
                exact(ViewChange(ViewNumber::new(4), EpochNumber::new(1))),
                validated_state_updated(),
                quorum_vote_send(),
            ],
        ...
        Expectations::from_outputs_and_task_states(
            all_predicates![
                ...
                exact(ViewChange(ViewNumber::new(5), EpochNumber::new(1))),
                validated_state_updated(),
                quorum_vote_send(),
            ],
            vec![no_decided_upgrade_certificate()],
        ...
        Expectations::from_outputs_and_task_states(
            all_predicates![
                ...
                exact(ViewChange(ViewNumber::new(6), EpochNumber::new(1))),
                validated_state_updated(),
                quorum_vote_send(),
            ],
            vec![no_decided_upgrade_certificate()],
