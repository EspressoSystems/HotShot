...
// After the changes to the certificates' view number, the liveness check never occurs
// because we always fetch a missing proposal in advance. This is because the corresponding
// leaf is the only trusted source of justify QC's view number.
...
//     consensus_writer.update_saved_leaves()
//     consensus_writer
