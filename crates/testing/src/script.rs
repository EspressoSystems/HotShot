...
pub struct TaskScript<TYPES: NodeType, S> {
    ...
    /// Whether trailing events generated by the test should be ignored.
    ///
    /// If set to `true`, anything received after all outputs have been seen is completely ignored.
