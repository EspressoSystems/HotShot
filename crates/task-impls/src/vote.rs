...
>
{
    ...
    fn get_leader(&self, membership: &TYPES::Membership) -> TYPES::PublicKey;

    /// return the Hotshot event for the completion of this CERT
    fn make_cert_event(certificate: CERT, key: &TYPES::PublicKey) -> HotShotEvent<TYPES>;
}
