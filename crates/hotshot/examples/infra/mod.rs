...
pub async fn run_orchestrator<
    TYPES: NodeType,
    DACHANNEL: CommunicationChannel<TYPES, Message<TYPES>, TYPES::Membership> + Debug,
    QUORUMCHANNEL: CommunicationChannel<TYPES, Message<TYPES>, TYPES::Membership> + Debug,
    VIEWSYNCCHANNEL: CommunicationChannel<TYPES, Message<TYPES>, TYPES::Membership> + Debug,
    VIDCHANNEL: CommunicationChannel<TYPES, Message<TYPES>, TYPES::Membership> + Debug,
    NODE: NodeImplementation<
        TYPES,
        Exchanges = Exchanges<
            TYPES,
            Message<TYPES>,
            QuorumExchange<TYPES, TYPES::Membership, QUORUMCHANNEL, Message<TYPES>>,
            CommitteeExchange<TYPES, TYPES::Membership, DACHANNEL, Message<TYPES>>,
            ViewSyncExchange<TYPES, TYPES::Membership, VIEWSYNCCHANNEL, Message<TYPES>>,
            VIDExchange<TYPES, TYPES::Membership, VIDCHANNEL, Message<TYPES>>,
        >,
...
pub struct WebServerDARun<TYPES: NodeType, I: NodeImplementation<TYPES>> {
    config: NetworkConfig<TYPES::SignatureKey, TYPES::ElectionConfigType>,
    quorum_channel: WebCommChannel<TYPES, I, TYPES::Membership>,
    da_channel: WebCommChannel<TYPES, I, TYPES::Membership>,
    view_sync_channel: WebCommChannel<TYPES, I, TYPES::Membership>,
    vid_channel: WebCommChannel<TYPES, I, TYPES::Membership>,
}
    ...
    Self: Sync,
{
    async fn initialize_networking(
        ...
        let quorum_channel: WebCommChannel<TYPES, NODE, TYPES::Membership> =
            WebCommChannel::new(underlying_quorum_network.clone().into());

        let view_sync_channel: WebCommChannel<TYPES, NODE, TYPES::Membership> =
            WebCommChannel::new(underlying_quorum_network.into());

        let da_channel: WebCommChannel<TYPES, NODE, TYPES::Membership> = WebCommChannel::new(
            WebServerNetwork::create(
                &host.to_string(),
                port,
                wait_between_polls,
        ...
        let vid_channel: WebCommChannel<TYPES, NODE, TYPES::Membership> = WebCommChannel::new(
    ...
    fn get_da_channel(&self) -> WebCommChannel<TYPES, NODE, TYPES::Membership> {
        self.da_channel.clone()
    }

    fn get_quorum_channel(&self) -> WebCommChannel<TYPES, NODE, TYPES::Membership> {
        self.quorum_channel.clone()
    }

    fn get_view_sync_channel(&self) -> WebCommChannel<TYPES, NODE, TYPES::Membership> {
        self.view_sync_channel.clone()
    }

    fn get_vid_channel(&self) -> WebCommChannel<TYPES, NODE, TYPES::Membership> {
...
pub struct Libp2pDARun<TYPES: NodeType, I: NodeImplementation<TYPES>> {
    config: NetworkConfig<TYPES::SignatureKey, TYPES::ElectionConfigType>,
    quorum_channel: Libp2pCommChannel<TYPES, I, TYPES::Membership>,
    da_channel: Libp2pCommChannel<TYPES, I, TYPES::Membership>,
    view_sync_channel: Libp2pCommChannel<TYPES, I, TYPES::Membership>,
    vid_channel: Libp2pCommChannel<TYPES, I, TYPES::Membership>,
}
    ...
    Self: Sync,
{
    async fn initialize_networking(
        ...
        // create communication channels
        let quorum_channel: Libp2pCommChannel<TYPES, NODE, TYPES::Membership> =
            Libp2pCommChannel::new(underlying_quorum_network.clone().into());

        let view_sync_channel: Libp2pCommChannel<TYPES, NODE, TYPES::Membership> =
            Libp2pCommChannel::new(underlying_quorum_network.clone().into());

        let da_channel: Libp2pCommChannel<TYPES, NODE, TYPES::Membership> =
            Libp2pCommChannel::new(underlying_quorum_network.clone().into());

        let vid_channel: Libp2pCommChannel<TYPES, NODE, TYPES::Membership> =
            Libp2pCommChannel::new(underlying_quorum_network.clone().into());
    ...
    fn get_da_channel(&self) -> Libp2pCommChannel<TYPES, NODE, TYPES::Membership> {
        self.da_channel.clone()
    }

    fn get_quorum_channel(&self) -> Libp2pCommChannel<TYPES, NODE, TYPES::Membership> {
        self.quorum_channel.clone()
    }

    fn get_view_sync_channel(&self) -> Libp2pCommChannel<TYPES, NODE, TYPES::Membership> {
        self.view_sync_channel.clone()
    }

    fn get_vid_channel(&self) -> Libp2pCommChannel<TYPES, NODE, TYPES::Membership> {
        self.vid_channel.clone()
    }
        ...
        NODE: NodeImplementation<
            ...
            Exchanges = Exchanges<
                ...
                ViewSyncExchange<
                    ...
                    Message<TYPES>,
                >,
                VIDExchange<TYPES, TYPES::Membership, CombinedCommChannel<TYPES>, Message<TYPES>>,
            >,
            Storage = MemoryStorage<TYPES>,
        >,
    >
