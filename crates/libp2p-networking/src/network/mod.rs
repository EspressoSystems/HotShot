...
use self::behaviours::{
    ...
    gossip::GossipEvent,
    request_response::{ResponseRequested, VidReqeust, VidResponse},
};
use bincode::Options;
...
/// Events from the swarm the client requested
#[derive(Debug)]
pub enum ResponseEvent {
    /// Response with VID data
    VidResponse(VidResponse, OutboundRequestId),
}
...
pub enum NetworkEventInternal {
    ...
    RequestResponseEvent(libp2p::request_response::Event<VidReqeust, VidResponse>),
}
